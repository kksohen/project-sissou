...
export default function CommentList({
  ...
  return(
    ...
    <div className="flex gap-2 pt-3">
      ...
      src={user.avatar} alt={user.username} width={48} height={48} priority/> : 
      ...
      <div className="*:text-xs *:md:text-sm *:lg:text-base flex-1">
        ...
        <p className="font-weight-form username-spacing-desc opacity-70 break-all whitespace-pre-wrap text-wrap">{payload}</p>
      </div>
    </div>
