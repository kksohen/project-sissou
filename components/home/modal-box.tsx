    ...
    flex items-center justify-center backdrop-blur-lg">
      ...
      font-weight-custom dark:tracking-normal">
        <div className="flex flex-col items-center">
          ...
          <p className="italic font-extrabold">&#12298;PROJECT SISSOU&#12299;</p>
        ...
        <div>
          <p><span className="italic font-extrabold">&#12298;SISSOU&#12299;</span> 는 일본어 동음이의어인 失踪(실종)과 疾走(질주)를 활용한 언어유희로, 상실과 나아감에 대한 질문을 내포한다. 이러한 맥락에서 인트로는 도주와 질주 사이의 모호함으로 움직임의 방향성을 관객의 판단에 맡긴다. 이를 통해 전진과 후퇴 모두 개인의 선택이자 해석임을 보여준다.</p>
        </div>

        <div className="w-full">
          <p>더 나아가 이 프로젝트는 . . . <Link href="/brand" className="italic font-extrabold" data-cursor-target>더 보기</Link></p>
        </div>
      </div>
      ):(
      <div onClick={(e)=> e.stopPropagation()}
    ...
    text-center font-weight-custom dark:tracking-normal">
      ...
      xl:gap-8 lg:gap-7 md:gap-6 sm:gap-5">
        <div className="text-right">
          <p><span className="italic font-extrabold">&#12298;SISSOU&#12299;</span> 는 일본어 동음이의어인</p>
