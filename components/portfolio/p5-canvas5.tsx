...
import { sketch5 } from "@/lib/p5/sketch-5";
...
const P5Canvas5 = ({work}: P5CanvasProps) => {
  ...
  useEffect(() => {
    ...
    import("p5").then((p5Module)=>{
      ...
      const sketchInstance = sketch5(dimension);
...
P5Canvas5.displayName = "P5Canvas5";
export default P5Canvas5;