...
import { sketch4 } from "@/lib/p5/sketch-4";
...
const P5Canvas4 = ({work, model}: P5CanvasProps) => {
  ...
  useEffect(() => {
    ...
    import("p5").then((p5Module)=>{
      ...
      const sketchInstance = sketch4(dimension, model);
...
P5Canvas4.displayName = "P5Canvas4";
export default P5Canvas4;