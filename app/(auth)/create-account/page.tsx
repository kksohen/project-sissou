  ...
  return(
    <div className="mt-10 max-w-full lg:max-w-4/5 xl:max-w-3/5 mx-auto">
      ...
      flex flex-col justify-center items-center gap-3 text-center">
        ...
        <h1 className="font-weight-basic text-3xl leading-7 custom-tracking
        form-title">Register</h1>
        <h1 className="font-weight-basic text-2xl form-h2">회원가입</h1>
      </div>

      <form action={action} className="flex flex-col gap-3 mb-5">
        <FormInput name="username" required type="text" placeholder="Name"
        ...
        errors={state?.fieldErrors.password} minLength={PASSWORD_MIN_LENGTH}
        value={formData.password} onChange={handleChange}
        />
        <FormInput name="confirm_password" required type="password" placeholder="Confirm Password"
