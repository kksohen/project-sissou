  ...
  return(
    <div className="mt-10 max-w-full lg:max-w-4/5 xl:max-w-3/5 mx-auto">
      ...
      <div className="flex justify-end-safe">
        <Link data-cursor-target href="/create-account" className="form-text-color opacity-40 hover:opacity-100 transition-all font-weight-form lg:text-lg">회원가입 · Register</Link>
      </div>
