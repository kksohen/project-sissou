  ...
  return(
    <div className="my-10">
      ...
      mode-svg-color-50 backdrop-blur-lg shadow-[0_8px_32px_rgba(0,0,0,0.02)]">
        ...
        <div className="mx-auto max-w-screen-xs sm:max-w-lg md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg 2xl:max-w-screen-xl">
          ...
          <div className="flex gap-2 items-center pt-2">
            ...
            {post.user.avatar ? <Image className="rounded-full"
            src={post.user.avatar} alt={post.user.username} width={48} height={48} priority/> : 
      ...
      <div className="pt-32 sm:pt-36 md:pt-40">
        <p className="font-weight-form username-spacing-desc lg:text-lg md:leading-5 lg:leading-6 opacity-70">{post.description}</p>
