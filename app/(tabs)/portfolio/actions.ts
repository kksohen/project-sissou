...
const allWorks: IWork[] = [
  ...
  },
  {
    ...
    category: ["motion"] as const,
    detailImages: [
      "/assets/images/mockup/three4-1.jpg",
      "/assets/images/mockup/three4-2.jpg",
      "/assets/images/mockup/three4-3.jpg",
      "/assets/images/mockup/three4-4.jpg",
      "/assets/images/mockup/three4-5.jpg",
      "/assets/images/mockup/three4-6.jpg",
      "/assets/images/mockup/three4-7.jpg",
      "/assets/images/mockup/three4-8.jpg",
      "/assets/images/mockup/three4-9.jpg",
      "/assets/images/mockup/three4-10.jpg",
      "/assets/images/mockup/three4-11.jpg",
      "/assets/images/mockup/three4-12.jpg",
    ],
  },
  {
    id: 17,
    ...
    image: "/assets/images/mockup/p55-thum.jpg",
    pixel: "",
    category: ["motion"] as const,
    detailImages: [],
  },
  {
    ...
    project: "Personal",
    tools: ["P5JS"],
    desc: "P5JS를 활용한 제너레이티브 아트워크입니다. 캔버스 위에서 마우스 클릭 시 펄린 노이즈 기반의 유기적인 선과 면이 왕복하며 능선을 그려냅니다.",
  ...
  },
  {
    ...
    project: "Personal",
    tools: ["ThreeJS", "WebGL", "Shader"],
    desc: "ThreeJS와 Shader로 제작한 메타볼 시리즈입니다. Smooth Minimum 함수를 활용한 1, 거리 기반 구현의 2, Threshold를 적용한 3의 시각적 차이를 관찰할 수 있습니다.",
    image: "/assets/images/mockup/three3-thum.jpg",
    pixel: "",
    category: ["motion"] as const,
    detailImages: [],
  },
  {
    ...
    project: "Personal",
    tools: ["ThreeJS", "WebGL", "Shader"],
    desc: "ThreeJS와 Shader를 활용한 제너레이티브 아트워크로, 사용자의 실제 환경을 8각 대칭 만화경으로 변환해 기하학적인 패턴을 그려냅니다.",
    image: "/assets/images/mockup/three2-thum.jpg",
    pixel: "",
    category: ["motion"] as const,
    detailImages: [],
  },
  {
    ...
    project: "Personal",
    tools: ["ThreeJS", "WebGL", "Shader"],
    desc: "ThreeJS와 Shader를 활용한 제너레이티브 아트워크로, 마우스 움직임과 시간의 흐름에 따라 사이키델릭한 만화경 효과를 그려냅니다.",
    image: "/assets/images/mockup/three1-thum.jpg",
    pixel: "",
    category: ["motion"] as const,
    detailImages: [],
  },
  {
    ...
    desc: "P5JS와 MediaPipe를 활용한 인터랙티브 아트워크로, 사용자의 눈과 손을 인식해 동작하는 모션 그래픽을 제작했습니다. 눈 밑에 검지를 대면 흘러내리는 눈물을 볼 수 있습니다.",
    image: "/assets/images/mockup/p54-thum.jpg",
    pixel: "",
    category: ["motion"] as const,
    detailImages: [],
  },
  ...
  },
  {
    ...
    project: "Personal",
    tools: ["P5JS"],
    desc: "P5JS로 제작한 드로잉 툴입니다. 캔버스 위에서 마우스 클릭 혹은 드래그 시 흩뿌려지는 입자 브러시 형태의 만다라 문양을 그릴 수 있습니다.",
